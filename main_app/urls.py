...
from main_app.views import RegisterCustomerView, HomeView, SellersView, CartView, OrdersView, NewOrderEmailView, AdminUtilsView
...
urlpatterns = [
    ...
    path('new_order_email/', NewOrderEmailView.as_view(), name='new_order_email'),
    path('update_cart_promo_code/', update_cart_promo_code, name='update_cart_promo_code'),
    path('admin/', admin.site.urls),
    path('admin_utils/', AdminUtilsView.as_view(), name='admin_utils'),
